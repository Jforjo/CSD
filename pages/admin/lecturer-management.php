...
<section class="user-management" id="lecturer-management">
    <div class="table-header">
        <div class="table-perpage">
            ...
            <select id="user-management-perpage">
                ...
                <option value="20" <?php if ($lecturerCount <= 15) echo "hidden"; ?>>20</option>
                <option value="25" <?php if ($lecturerCount <= 20) echo "hidden"; ?>>25</option>
                <option value="50" <?php if ($lecturerCount <= 25) echo "hidden"; ?>>50</option>
                <option value="100" <?php if ($lecturerCount <= 50) echo "hidden"; ?>>100</option>
            </select>
            Entries
        </div>
    ...
    <div class="pagination">
        <span>Showing <i id="pagination-showing"><?php echo min($lecturerCount, 1); ?></i> to <i id="pagination-perpage"><?php echo min($lecturerCount, 5); ?></i> of <i id="pagination-total"><?php echo $lecturerCount; ?></i> entries</span>
        <nav>
            <div class="arrow">
            ...
            <ul id="pagination-menu">
                ...
                <?php for ($i=2; $i <= ceil($lecturerCount / 5); $i++) { ?>
